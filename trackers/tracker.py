...
import sys
sys.path.append('../')
from utils import get_center_of_bbox, get_bbox_wdth, get_foot_position
import cv2
import numpy as np
import pandas as pd
...
class Tracker:
    ...
    def draw_team_control(self, frame, frame_num, team_ball_control):
        ...
        # get the number of frames each team had control
        team1_frames = team_ball_control_till_frame[team_ball_control_till_frame == 1].shape[0]
        team2_frames = team_ball_control_till_frame[team_ball_control_till_frame == 2].shape[0]
        team_1 = team1_frames / (team1_frames + team2_frames)
